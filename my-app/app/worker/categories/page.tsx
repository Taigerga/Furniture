                ...
                <li key={c.id} className="rounded-[3px] border border-[#E2E8F0] bg-white p-4">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <div>
                      ...
                      <p className="text-xs text-[#64748B]">/{c.slug} · {c._count.products} produk{mine ? "" : " · milik admin"}</p>
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      {mine && (c.approvalStatus === "DRAFT" || c.approvalStatus === "REJECTED") && (
                        <form action={submitWorkerCategory.bind(null, c.id)}>
                          <button type="submit" className="rounded-[3px] bg-[#0A192F] px-3 py-1 text-xs font-medium text-white transition hover:bg-[#0A192F]">
                            Ajukan
                          </button>
                        </form>
                      )}
