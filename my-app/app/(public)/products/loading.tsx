export default function ProductsLoading() {
  return (
    <main className="mx-auto max-w-6xl px-4 py-12" aria-label="Memuat katalog" role="status">
      ...
      <div className="mt-6 h-11 w-full max-w-md animate-pulse rounded-[3px] bg-[#E2E8F0]" />
      <ul className="mt-8 grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
        {Array.from({ length: 8 }, (_, i) => (
          <li key={i} className="overflow-hidden rounded-[3px] border border-[#E2E8F0] bg-white">
            <div className="aspect-[4/3] animate-pulse bg-[#E2E8F0]" />
