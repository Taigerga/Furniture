    ...
    <div>
      ...
      <form action="/admin/products" method="get" className="mb-4 flex flex-wrap gap-2">
        ...
        <select
          name="status"
          defaultValue={status}
          className="rounded-[3px] border border-[#CBD5E1] bg-white px-3 py-2 text-sm"
        ...
        <button type="submit" className="rounded-[3px] bg-[#0A192F] px-4 py-2 text-sm font-medium text-white">
          Filter
        </button>
      </form>
