...
export const CompanyProfileSchema = z.object({
  ...
  latitude: z.preprocess(
    ...
    z.coerce.number().min(-90, "Latitude antara -90 dan 90.").max(90, "Latitude antara -90 dan 90.").optional(),
  ),
  longitude: z.preprocess(
    (v) => (v === "" || v === null || v === undefined ? undefined : v),
    z.coerce.number().min(-180, "Longitude antara -180 dan 180.").max(180, "Longitude antara -180 dan 180.").optional(),
  ),
});
