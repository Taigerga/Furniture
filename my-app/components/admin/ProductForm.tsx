...
export function ProductForm({
  ...
  return (
    <form action={formAction} className="space-y-4 rounded-[3px] border border-[#E2E8F0] bg-white p-6">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <div className="flex items-end gap-2 pb-2">
          ...
          <label htmlFor="pf-featured" className="text-sm text-[#334155]">Unggulan (homepage)</label>
        </div>
      </div>
      <div>
      ...
      <button
        type="submit"
        disabled={pending}
        className="rounded-[3px] bg-[#0A192F] px-6 py-2.5 text-sm font-medium text-white transition hover:bg-[#13233F] disabled:opacity-60"
      >
